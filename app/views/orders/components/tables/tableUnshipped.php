...
<div class="h-auto bg-gray-50 drop-shadow-lg my-8 rounded-lg ">
            ...
            <div class="shadow-lg rounded-lg overflow-hidden p-4 text-center ease-in-out duration-500 hidden"
                id="UnshippedOrders">
                        ...
                        <div class="py-4 inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="overflow-hidden p-8">
                                <table class="min-w-full text-center border border-black border my-4"
                                    ...
                                    <tbody>
                                        ...
                                        if($orders[$i]['shipping_status'] == 'unshipped'):?>
                                        <tr class="bg-white border-b">

                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"
                                                data-order-id="<?php echo($orders [$i]['id']);?>">
                                                <input type="checkbox" class="checkboxDataTableUnshipped"
                                                    id="<?php $orders [$i]['id']?>">
                                            </td>
                            ...
                            <div id="botoneraTables" class="flex wrap">
                                ...
                                <div class="w-3/5 inline px-6 py-2.5">
                                    <label class="hidden float-left" id="p-action-unshipped" for="actionSelect">Por favor seleccione una
                                        accion</label>
                                    <div class="relative flex w-full">
                                        <select name="actionSelect" id="actionSelectUnshipped"
                                            ...
                                            <option value="3">Creacion de envio en masa</option>
                                        </select>
                                        <button id="actionButtonUnshipped"
                                ...
                                <div class="w-2/5 inline px-6 py-2.5">
                                    <div class="relative flex w-full h-full">
                                        <button id="selectAllBtnUnshipped" data-select-all="true"
        ...
        <script src="<?php echo $_ENV['URL']?>public/js/tables/tableUnshipped.js"></script>
        <?php
    }
}